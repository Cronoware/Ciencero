        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Ingresa los datos del puesto</h6>              
              <form method="GET" action="/Clase1/busqueda">
                    <input id="nombre02" name="nombrePuesto" type="text" placeholder="Nombre del puesto" class="w3-border w3-padding-large">
                    <p>
                    <input id="nombre02" name="comidas" type="text" placeholder="Comidas del puesto (Separadas por comas)" class="w3-border w3-padding-large">
                    <p>
                    <button class="w3-bar-item w3-button w3-padding-large w3-theme-d4" title="Notifications">Buscar</button> 
              </form>              
            </div>
          </div>
        </div>
