...
<% List <Puesto> puestos = Controlador.getResultados();%>
     ...
     <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
        <%for(Puesto p : puestos){%>
            ...
            <form method="GET" action="/Clase1/verPuestoIH">
                <h4><%out.println("ID del puesto:" + p.getPuesto_id() + "- Nombre:" + p.getNombre());%></h4>       
                <input type="text" name="idPuesto" style="visibility: hidden" readonly value="<%out.println(p.getPuesto_id());%>"/>
                <span class="w3-right w3-opacity"><button class="w3-button w3-theme-l1 w3-left-align"></i>Ver Puesto</button></span>                     
