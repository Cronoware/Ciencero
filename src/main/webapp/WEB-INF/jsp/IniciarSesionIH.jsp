        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <form method="GET" action="/Clase1/iniciarSesion">                                  
                    <input id="nombre01" name="correo" type="text" placeholder="Correo" class="w3-border w3-padding-large">
                    <p>
                    <input id="nombre02" name="contra" type="password" placeholder="Contraseña" class="w3-border w3-padding-large">
                    <p>
                    <button class="w3-bar-item w3-button w3-padding-large w3-theme-d4" title="Notifications">Iniciar Sesion</button> 
              </form>       
