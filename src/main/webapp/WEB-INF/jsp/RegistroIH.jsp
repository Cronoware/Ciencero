          ...
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <form method="GET" action="/Clase1/paginaInicialIH">
                    ...
                    <p>
                    <input id="nombre02" name="fecha" type="text" placeholder="Fecha DD/MM/AAAA" class="w3-border w3-padding-large">
                    <p>
                    <input id="nombre02" name="carrera" type="text" placeholder="Carrera" class="w3-border w3-padding-large">
                    <p>
                    <input id="nombre02" name="imagen" type="text" placeholder="Ruta de la imagen" class="w3-border w3-padding-large">
                    <p>
